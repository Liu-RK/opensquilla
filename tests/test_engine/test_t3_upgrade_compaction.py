...
@pytest.mark.asyncio
async def test_flush_raises_logs_and_still_compacts() -> None:
    sm = _FakeSessionManager(_sample_transcript())
...
@pytest.mark.asyncio
async def test_flush_error_receipt_logs_and_still_compacts() -> None:
    sm = _FakeSessionManager(_sample_transcript())
...
@pytest.mark.asyncio
async def test_degraded_flush_receipts_log_and_still_compact(
...
@pytest.mark.asyncio
async def test_t3_flush_grace_timeout_does_not_block_compact() -> None:
    sm = _FakeSessionManager(_sample_transcript())
