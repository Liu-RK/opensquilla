...
BUNDLE_REL = Path("src/opensquilla/contrib/squilla_router/models/v4.2_phase3_inference")
...
def _source_note(rel_path: str) -> str:
    ...
    if rel_path.startswith("features/"):
        return "Router feature extraction artifact generated by the V4 Phase 3 training pipeline."
    if rel_path.startswith("mlp/"):
        return "Router MLP head artifact generated by the V4 Phase 3 training pipeline."
    if rel_path.startswith("lgbm_"):
        return "Router LightGBM head artifact generated by the V4 Phase 3 training pipeline."
